...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidCurrentPassword(InvalidCurrentPasswordException ex) {
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Invalid Current Password", ex.getMessage(), null);
    }

    @ExceptionHandler(InvalidVerificationTokenException.class)
    public ResponseEntity<ErrorResponse> handleInvalidVerificationToken(InvalidVerificationTokenException ex) {
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Invalid Verification Token", ex.getMessage(), null);
    }

    @ExceptionHandler(ExpiredVerificationTokenException.class)
    public ResponseEntity<ErrorResponse> handleExpiredVerificationToken(ExpiredVerificationTokenException ex) {
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Expired Verification Token", ex.getMessage(), null);
    }
